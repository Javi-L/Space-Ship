const Game = {
  ...
  reset: function() {
    this.background = new Background(this.ctx, this.width, this.height, "images/background.png", 8);
...
for (let i = 0; i < this.enemies.length; i ++) {
  ...
  playerDamagedByMShip: function() {
 
      this.mShips[0].bulletsMShip.forEach(function(bullet) {
